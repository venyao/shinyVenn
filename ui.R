...
shinyUI(
  navbarPage(
    ...
    tabPanel(
      "venn diagram",
      tags$style("#color1cus {width:100%}
                  #color2cus {width:100%}
                  #color3cus {width:100%}
                  #color4cus {width:100%}
                  #color5cus {width:100%}
      ...
      sidebarPanel(width = 3,
                   ...
                   conditionalPanel(condition="input.data1",
                                    radioButtons("seluploaddata1", NULL, c("Disable data input" = "1", "Upload input data" = "2","Paste input data" = "3"), "1"),
                                    ...
                                    conditionalPanel(condition="input.seluploaddata1 == '2'",
                                                     ...
                                                     bsPopover("bsb01", '点击 "Browse" 上传数据（数据格式为一列，且每一行为一个元素）', trigger = "focus"),
                                    ...
                                    conditionalPanel(condition="input.seluploaddata1 == '3'",
                                                     ...
                                                     ), width="100%", resize="vertical", height="200px",placeholder = "One item in one row"),
                                                     bsPopover("bsb04", '将你的数据粘贴到文本框内（数据格式为一列，且每一行为一个元素）', trigger = "focus"),
                                                     textInput("Data1name",h5("Data label:",
                   ...
                   conditionalPanel(condition="input.data2",
                                    radioButtons("seluploaddata2", NULL, c("Disable data input" = "1", "Upload input data" = "2","Paste input data" = "3"), "1"),
                                    conditionalPanel(condition="input.seluploaddata2 == '2'",
                                                     ...
                                                     bsPopover("bsb07", '点击 "Browse" 上传数据（数据格式为一列，且每一行为一个元素）', trigger = "focus"),
                                    ...
                                    conditionalPanel(condition="input.seluploaddata2 == '3'",
                                                     ...
                                                     bsPopover("bsb10", '将你的数据粘贴到文本框内（数据格式为一列，且每一行为一个元素）', trigger = "focus"),
                                                     textInput("Data2name",h5("Data label:",
                   ...
                   conditionalPanel(condition="input.data3",
                                    radioButtons("seluploaddata3", NULL, c("Disable data input" = "1", "Upload input data" = "2","Paste input data" = "3"), "1"),
                                    conditionalPanel(condition="input.seluploaddata3 == '2'",
                                                     ...
                                                     bsPopover("bsb13", '点击 "Browse" 上传数据（数据格式为一列，且每一行为一个元素）', trigger = "focus"),
                                    ...
                                    conditionalPanel(condition="input.seluploaddata3 == '3'",
                                                     ...
                                                     bsPopover("bsb16", '将你的数据粘贴到文本框内（数据格式为一列，且每一行为一个元素）', trigger = "focus"),
                                                     textInput("Data3name",h5("Data label:",
                   ...
                   conditionalPanel(condition="input.data4",
                                    radioButtons("seluploaddata4", NULL, c("Disable data input" = "1", "Upload input data" = "2","Paste input data" = "3"), "1"),
                                    conditionalPanel(condition="input.seluploaddata4 == '2'",
                                                     ...
                                                     bsPopover("bsb19", '点击 "Browse" 上传数据（数据格式为一列，且每一行为一个元素）', trigger = "focus"),
                                    ...
                                    conditionalPanel(condition="input.seluploaddata4 == '3'",
                                                     ...
                                                     bsPopover("bsb22", '将你的数据粘贴到文本框内（数据格式为一列，且每一行为一个元素）', trigger = "focus"),
                                                     textInput("Data4name",h5("Data label:",
                   ...
                   conditionalPanel(condition="input.data5",
                                    radioButtons("seluploaddata5", NULL, c("Disable data input" = "1", "Upload input data" = "2","Paste input data" = "3"), "1"),
                                    conditionalPanel(condition="input.seluploaddata5 == '2'",
                                                     ...
                                                     bsPopover("bsb25", '点击 "Browse" 上传数据（数据格式为一列，且每一行为一个元素））', trigger = "focus"),
                                    ...
                                    conditionalPanel(condition="input.seluploaddata5 == '3'",
                                                     ...
                                                     bsPopover("bsb28", '将你的数据粘贴到文本框内（数据格式为一列，且每一行为一个元素）', trigger = "focus"),
                                                     textInput("Data5name",h5("Data label:",
                   ...
                   conditionalPanel(condition="input.data6",
                                    radioButtons("seluploaddata6", NULL, c("Disable data input" = "1", "Upload input data" = "2","Paste input data" = "3"), "1"),
                                    conditionalPanel(condition="input.seluploaddata6 == '2'",
                                                     ...
                                                     bsPopover("bsb31", '点击 "Browse" 上传数据（数据格式为一列，且每一行为一个元素）', trigger = "focus"),
                                    ...
                                    conditionalPanel(condition="input.seluploaddata6 == '3'",
                                                     ...
                                                     bsPopover("bsb34", '将你的数据粘贴到文本框内（数据格式为一列，且每一行为一个元素）', trigger = "focus"),
                                                     textInput("Data6name",h5("Data label:",
                   ...
                   conditionalPanel(condition="input.data7",
                                    radioButtons("seluploaddata7", NULL, c("Disable data input" = "1", "Upload input data" = "2","Paste input data" = "3"), "1"),
                                    conditionalPanel(condition="input.seluploaddata7 == '2'",
                                                     ...
                                                     bsPopover("bsb37", '点击 "Browse" 上传数据（数据格式为一列，且每一行为一个元素）', trigger = "focus"),
                                    ...
                                    conditionalPanel(condition="input.seluploaddata7 == '3'",
                                                     ...
                                                     bsPopover("bsb40", '将你的数据粘贴到文本框内（数据格式为一列，且每一行为一个元素）', trigger = "focus"),
                                                     textInput("Data7name",h5("Data label:",
                   ...
                   actionButton("submit1", strong("Submit"),class = "btn-primary"),
                   ...
                   sliderInput("textsize", h5("Set label font size",
                                              bsButton("bsb43", label="", icon=icon("question"), style="info", size="small")
                   ), min=0.5, max=5, value=0.8, step=0.1),
                   bsPopover("bsb43", "设置标签字体的大小", trigger = "focus"),
                   sliderInput("labelsize", h5("Set intersection label font size",
